...
class DayyyAttendanceVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        DaysSservice.shared.listenToDay(dayId: dayId) { newDay in
            self.day = newDay
...
extension DayyyAttendanceVC: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        DaysSservice.shared.switchStudentStatus(
            day: day!,
